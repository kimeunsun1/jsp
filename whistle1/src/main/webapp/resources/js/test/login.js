...
document.getElementById('lbtn').onclick = function(){
	...
	document.frm.setAttribute('action', '/whistle1/test/loginProc.pink');
...
$(document).ready(function(){
	...
	$('#lbtn').click(function(){
		...
		$('#frm').attr('action', '/whistle1/test/loginProc.pink');
		$('#frm').submit();
	});
	...
	$('#abtn').click(function(){
		...
		$.ajax({
			url: '/whistle1/test/loginAjax.pink',
			type: 'post',
			dataType: 'json',
			data: {
				id: tid,
