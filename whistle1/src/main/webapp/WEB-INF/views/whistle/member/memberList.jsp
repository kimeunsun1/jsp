...
<link rel="stylesheet" type="text/css" href="/whistle1/resources/css/user.css">
<script type="text/javascript" src="/whistle1/resources/js/jquery-3.6.0.min.js"></script>
<script type="text/javascript" src="/whistle1/resources/js/whistle/memberList.js"></script>
...
<body>
	<form method="POST" action="/whistle1/member/memberInfo.blp" name="frm" id="frm">
	<%--
		이 폼태그는 데이터 전송용 태그이다.
		따라서 화면에 보여지면 곤란하고
		이 폼태그가 전송될대 데이터는
