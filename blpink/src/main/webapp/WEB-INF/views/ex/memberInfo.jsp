...
<script type="text/javascript" src="/camp24/resources/js/ex/memberInfo.js"></script>
<style type="text/css">
	.avtbox {
	...
	<c:if test="${DATA.id ne SID}">
		...
		<div class="w3-col w3-margin-top w3-padding w3-card-4">
			...
			<div class="w3-rest w3-text-grey pdl20">
				...
				<h4><span class="w3-col w100 w3-right-align">회원이름 : </span><span class="w3-rest w3-center" id="name">${DATA.mname}</span></h4>
				...
				<h4><span class="w3-col w100 w3-right-align">이 메 일 : </span><span class="w3-rest w3-center" id="mail">${DATA.email}</span></h4>
