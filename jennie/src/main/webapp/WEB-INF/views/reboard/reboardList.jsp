...
<body>
	<div class="w3-content mxw750 w3-margin-top">
		...
		<header class="w3-col w3-card-4 mgb20">
			<h1 class="w3-pink w3-center w3-padding mg0">BlackPink 댓글게시판</h1>
...
<c:forEach var="data" items="${LIST}">
		<div class="w3-col" style="padding-left: ${data.step * 70}px">
			...
			<c:if test="${SID eq data.id}">
						...
						<span class="w3-third w3-right mgb10 ft10"><small>${data.sdate}</small></span>
					</div>
...
<c:if test="${not empty MSG}">	
	<div id="modal" class="w3-modal" style="display: bolck;">
