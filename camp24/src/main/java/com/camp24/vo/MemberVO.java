...
public class MemberVO {
	...
	private String id, mname, pw, email, tel, sdate, savename, gen;
	private Date jdate;
	private Time jtime;
	public int getMno() {
		return mno;
	...
	public String toString() {
		return "MemberVO [mno=" + mno + ", ano=" + ano + ", cnt=" + cnt + ", id=" + id + ", mname=" + mname + ", pw="
				+ pw + ", email=" + email + ", tel=" + tel + ", sdate=" + sdate + ", savename=" + savename + ", gen="
				+ gen + ", joindate=" + jdate + ", jointime=" + jtime + "]";
	}
